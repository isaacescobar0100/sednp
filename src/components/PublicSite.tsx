...
import { ArrowLeftIcon, ArrowRightIcon, CalendarDaysIcon, GlobeIcon, LogInIcon, MegaphoneIcon, MenuIcon, UserPlusIcon, XIcon } from 'lucide-react'
...
type View = 'inicio' | 'blog' | 'post' | 'anuncios' | 'quienes-somos' | 'servicios' | 'contacto'
const NAV: Array<{ v: View; label: string }> = [
  { v: 'inicio', label: 'Inicio' }, { v: 'blog', label: 'Blog' }, { v: 'servicios', label: 'Servicios' },
  { v: 'quienes-somos', label: 'Quiénes somos' }, { v: 'anuncios', label: 'Anuncios' }, { v: 'contacto', label: 'Contacto' },
]
